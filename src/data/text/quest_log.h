...
const u8 gText_QuestLog_UsedCut[] = _("{PLAYER} used the Hidden Move\nCUT here.");
const u8 gText_QuestLog_UsedFly[] = _("{PLAYER} used the Hidden Move\nFLY and flew to {STR_VAR_2}.");
const u8 gText_QuestLog_UsedSurf[] = _("{PLAYER} used the Hidden Move\nSURF and rode the waves.");
const u8 gText_QuestLog_UsedStrength[] = _("{PLAYER} used the Hidden Move\nSTRENGTH here.");
const u8 gText_QuestLog_UsedFlash[] = _("{PLAYER} used the Hidden Move\nFLASH and illuminated a pitch-black\ncave.");
const u8 gText_QuestLog_UsedRockSmash[] = _("{PLAYER} used the Hidden Move\nROCK SMASH here.");
const u8 gText_QuestLog_UsedWaterfall[] = _("{PLAYER} used the Hidden Move\nWATERFALL to scale a raging torrent."); // Unused
const u8 gText_QuestLog_UsedDive[] = _("{PLAYER}は　ふかい　ところを　めざし\nひでんわざ\nダイビングを　つかった！");
const u8 gText_QuestLog_UsedDigInLocation[] = _("{PLAYER} used DIG to escape from\n{STR_VAR_2}.");
const u8 gText_QuestLog_UsedSweetScent[] = _("{PLAYER} used SWEET SCENT to attract\nwild POKéMON.");
const u8 gText_QuestLog_UsedTeleportToLocation[] = _("{PLAYER} used TELEPORT, transporting\nthe party to {STR_VAR_2}'s\n{STR_VAR_3}.");
