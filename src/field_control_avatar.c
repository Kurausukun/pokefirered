...
{
    if (MetatileBehavior_IsSemiDeepWater(metatileBehavior) == TRUE && FlagGet(FLAG_BADGE05_GET) && FlagGet(FLAG_GOT_HM03))
        return EventScript_CurrentTooFast;
    if (FlagGet(FLAG_BADGE05_GET) == TRUE && IsPlayerFacingSurfableFishableWater() == TRUE && FlagGet(FLAG_GOT_HM03))
